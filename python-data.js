  ...
  const source = [
    ...
    m(18, "Packaging, Performance & Security", "advanced",
      ...
      [
        ...
        t("TestPyPI & PyPI publishing", "Build artifacts should be checked and tested on TestPyPI before publishing a release to the main Python Package Index.", "PUBLISH", "python -m pip install twine\npython -m twine check dist/*\npython -m twine upload --repository testpypi dist/*"),
        ...
        t("Secure defaults", "Use secrets for security tokens, avoid untrusted pickle data, pass subprocess arguments as a list, and keep production servers purpose-built.", "SECURITY", "import secrets, subprocess\ntoken = secrets.token_urlsafe(32)\nsubprocess.run([\"git\", \"status\"], check=True, shell=False)\n# Never unpickle untrusted bytes.")
      ])
  ];
