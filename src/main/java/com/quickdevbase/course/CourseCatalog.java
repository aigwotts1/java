...
public class CourseCatalog {
    ...
    public CourseCatalog() {
        add(new Course("java", "java-basecamp-complete", "Java Topics at a Glance", "Java at a Glance", "J", 18, 148, "/java",
            "Java fundamentals, OOP, collections, Java 8 through 21, Spring Boot, REST APIs, JVM internals, testing, and DSA.",
            "Java is a trademark of Oracle and/or its affiliates. QuickDevBase is not affiliated with or endorsed by Oracle."));
        add(new Course("docker", "docker-developer-knowledge", "Docker Topics at a Glance", "Docker at a Glance", "D", 18, 126, "/docker",
        ...
        add(new Course("generative-ai", "generative-ai-foundations", "Generative AI Topics at a Glance", "Generative AI at a Glance", "G", 12, 84, "/ai/generative-ai",
            ...
            independentAiNotice()));
        add(new Course("rag", "rag-systems-knowledge", "RAG Systems Topics at a Glance", "RAG at a Glance", "R", 12, 84, "/ai/rag",
            ...
            independentAiNotice()));
        add(new Course("agentic-ai", "agentic-ai-knowledge", "Agentic AI Topics at a Glance", "Agentic AI at a Glance", "A", 12, 84, "/ai/agents",
