...
class CourseCatalogTest {
    ...
    void keepsAllCourseScopesAndCountsStable() {
        ...
        assertEquals(18, courses.byKeyOrJava("git").moduleCount());
        assertEquals(126, courses.byKeyOrJava("git").conceptCount());
        ...
        assertEquals("Git Topics at a Glance", courses.byKeyOrJava("git").title());
    }
    ...
    void defaultsUnknownCourseKeysToJavaForBackwardCompatibility() {
        ...
        assertEquals("git", courses.byCode("git-developer-knowledge").orElseThrow().key());
    }
}
